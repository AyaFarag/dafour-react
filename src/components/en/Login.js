                        ...
                        <div className="row planType">
                          <p className="lead text-center w-100">Sign In To Student Account.</p>
                            <div className="col-12">
                              <input className="input-group p-3" placeholder="Username Or Email" name="username" onChange={this.onChange} />
                            </div>
                            <div className="col-12 mt-3">
                              <input className="input-group p-3" type="password" placeholder="Password" name="password" onChange={this.onChange} />
                            </div>
