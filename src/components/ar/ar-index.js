...
class ar-index extends Component {
...
<div id="loadContainer"> 
  ...
  <section class="slideshow w-100 d-inline-block m-0 p-0">
    <div class="row m-0 p-0"> <img class="d-block img-fluid w-100" src="images/bg.jpg">
      <div class="search py-5 px-4">
        ...
        <div class="col-12">
          <input class="input-group p-3" placeholder="كلمات البحث">
        </div>
  ...
  <div class="backimg w-100 d-inline-block" id="about">
    <section class="about w90">
      <h1 class="text-center p-4">أحدث الأوراق</h1>
      <div class="row m-0 align-items-center">
        <div class="col-md-12 text-center align-items-center">
          <ul class="list-inline text-center align-self-center align-items-center list-items paper-list">
            <li class="list-inline-item m-0 p-3 list-items-active font-weight-bold" id="generalEducation">تعليم عام</li>
            <li class="list-inline-item m-0 p-3 font-weight-bold " id="universityEducation">تعليم جامعي</li>
            <li class="list-inline-item m-0 p-3 font-weight-bold" id="vocationalEducation">التعليم الفني</li>
          </ul>
        </div>
      </div>
      <div id="paperTabs">
        <div class="row m-0 generalEducation">
          <div class="col-md-4 text-left mt-4">
            <div class="row h-100 m-0 paper">
              ...
              <div class="col-12 align-self-center">
                <ul class="list-group">
                  <li class="list-group-item d-flex"><span class="badge"><img src="images/author-sign.png"/></span>المؤلفون</li>
                  <li class="list-group-item d-flex"><span class="badge"><img src="images/calendar-tool-for-time-organization.png"/></span>سنة النشر</li>
                  <li class="list-group-item d-flex"><span class="badge"><img src="images/documents-button.png"/></span>الصفحات</li>
                </ul>
              </div>
              <div class="col-12 align-self-end mt-4 p-0"> <a class="btn  btn-block text-center align-items-end align-self-end p-2" href="#">التفاصيل
</a> </div>
            </div>
          </div>
          <div class="col-md-4 text-left mt-4">
  ...
  <div class="backimg w-100 d-inline-block" id="cmc">
    <section class="cmc-project w90">
      <h1 class="text-center p-4">انواع الباقات</h1>
      <div class="row m-0 align-items-center">
        <div class="col-md-12 text-center align-items-center">
          <ul class="list-inline text-center align-self-center align-items-center list-items plan-list">
            <li class="list-inline-item m-0 p-3 list-items-active font-weight-bold" id="planType">تعليم عام</li>
            <li class="list-inline-item m-0 p-3 font-weight-bold" id="accSetting">تعليم جامعي و فني</li>
          </ul>
        </div>
      </div>
          ...
          <div class="row my-4">
            <div class="col-md-4">
              <div class="card m-1 card-plan">
                ...
                <div class="card-block w-100 p-0"> <a href="#" class="btn btn-secondary w-100 font-weight-bold">شراء الآن</a> </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card m-1 card-plan active-plan">
                ...
                <div class="card-block w-100 p-0"> <a href="#" class="btn btn-secondary w-100 font-weight-bold">Buy Now</a> </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card m-1 card-plan">
