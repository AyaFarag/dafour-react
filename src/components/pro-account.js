...
class pro-account extends Component {
...
<main class="pages"> 
  ...
  <div class="backimg w-100 d-inline-block mt-5" id="about">
    <section class="about w90 mt-5">
      <div class="row m-0">
        <h1 class="text-center p-4 w-100">My Account</h1>
        <div class="container m-auto align-items-center text-center">
          <div class="col-md-12 text-center align-items-center">
            <ul class="list-inline text-center align-self-center align-items-center plan-list list-items">
              <li class="list-inline-item m-0 p-3 list-items-active font-weight-bold" id="planType">Plan Type</li>
              <li class="list-inline-item m-0 p-3 font-weight-bold" id="Mydocs">My Documents</li>
              <li class="list-inline-item m-0 p-3 font-weight-bold" id="accSetting">Account Setting</li>
            </ul>
          </div>
        </div>
        <div class="w-100" id="planTabs">
          ...
          <div class="col-md-4 text-left mt-4">
            <div class="row h-100 m-0 paper">
              ...
              <div class="col-12 align-self-end mt-4 p-0"> <a class="btn  btn-block text-center align-items-end align-self-end p-2" href="#">Edit </a> </div>
            </div>
          </div>
          <div class="col-md-4 text-left mt-4">
            <div class="row h-100 m-0 paper">
          ...
          <div class="container accSetting">
            <div class="row h-100 m-0 paper">
              <div class="row m-0">
               <form class="row m-0">
                <label class="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Name</label>
                <div class="col-sm-4 mt-1">
                  <input class="input-group p-3" type="text" placeholder="First Name">
                </div>
                <div class="col-sm-4 mt-1">
                  <input class="input-group p-3" type="text" placeholder="Middle Name">
                </div>
                <div class="col-sm-4 mt-1">
                  <input class="input-group p-3" type="text" placeholder="Last Name">
                </div>
                <label class="w-100 px-3 py-0 mx-0 mt-3 text-left">Degree</label>
                <div class="col-12 mt-1">
                  <input class="input-group p-3" type="text" placeholder="Degree">
                </div>
                <label class="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Email</label>
                <div class="col-12 mt-1">
                  <input class="input-group p-3" type="email" placeholder="You Email">
                </div>
                <label class="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Password</label>
                <div class="col-12 mt-1">
                  <input class="input-group p-3" type="password" placeholder="Your Password">
                </div>
                <div class="col-12 mt-1">
                  <input class="input-group p-3" type="password" placeholder="Confirm Password">
                </div>
                <label class="w-100 px-3 py-0 mx-0 mt-3 text-left">Phone Number</label>
                <div class="col-12 mt-1">
                  <input class="input-group p-3" type="tel" placeholder="Your Phone Number">
                </div>
                <label class="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Country</label>
                <div class="col-12 mt-1">
              ...
              <div class="col-12 my-3 w-100 text-center">
                <button class="btn-login py-2 px-5 font-weight-bold">Update</button>
              </div>
            </div>
          </div>
        </div>
