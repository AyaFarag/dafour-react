        ...
        <section class="slideshow w-100 d-inline-block m-0 p-0">
            <div class="row m-0 p-0"><img class="d-block img-fluid w-100 position-absolute" src="images/bg.jpg">
                <div class="search py-5 px-4">
                    <p class="lead text-center">Create New Account.</p>
                    <div class="container m-auto align-items-center text-center">
                        <div class="col-md-12 text-center align-items-center">
                            <ul class="list-inline text-center align-self-center align-items-center plan-list list-items">
                                <li class="list-inline-item m-0 p-3 list-items-active font-weight-bold" id="planType">
                                    Student Sign Up
                                </li>
                                <li class="list-inline-item m-0 p-3 font-weight-bold" id="accSetting">Professional Sign
                                    Up
                                </li>
                            </ul>
                        </div>
                    ...
                    <div id="planTabs">
                        <div class="row m-0 planType">
                            <form class="row m-0">
                                <p class="lead col-12 text-center">Professional Sign Up</p>
                                <div class="file-field col-12">
                                    <div class="mb-4 mx-auto profile-img-container rounded-circle">
                                        <img id="profileImg"
                                             src="images/profile-pic.png"
                                             class="rounded-circle z-depth-1-half avatar-pic"
                                             alt="example placeholder avatar"/>
                                        <div class="clearfix h-100 rounded-circle position-relative"><span>Edit</span>
                                        </div>
                                    </div>
                                    <input class="d-none" id="imgUpload" type="file">
                                </div>
                        ...
                        <div class="row m-0 accSetting">
                            <form class="row m-0">
                                <p class="lead col-12 text-center">Student Sign Up</p>
                                <div class="col-sm-4 mt-3">
                                    <input class="input-group p-3" type="text" placeholder="First Name">
                                </div>
                                <div class="col-sm-4 mt-3">
                    ...
                    <div class="col-12 mt-3">
                        <p class="text-left d-inline float-left">You Have An Account ? <a href="register.html">
                            <small>Sign In</small>
                        </a></p>
                        <p class="text-right d-inline float-right"><a href="register.html">
